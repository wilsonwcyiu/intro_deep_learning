...
if __name__ == '__main__':
    ...
    result_output_file = folder_dir + date_time_str + "_permutation_result_cnn_mnist_output.csv"
    result_backup_output_file = folder_dir + date_time_str + "_permutation_result_cnn_mnist_output_backup.csv"
    ...
    for dict_id in execute_dict_id_list:
        ...
        if dict_id % export_output_interval == 0:
            df = pd.DataFrame({
                ...
                'network_structure_id         ': network_structure_id_list           ,
                'loss                ': loss_list                  ,
