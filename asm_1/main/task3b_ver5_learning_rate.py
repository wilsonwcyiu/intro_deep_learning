...
if __name__ == '__main__':
    ...
    for name, learning_rate in learning_rate_dict.items():
        weight_vector = np.random.rand(1, 9) * (weight_high - weight_low) + weight_low
    ...
    plot_id = 1
    plot_title = "Cost performance over different learning rate"
    x_label = "Iterations"
    y_label = "Cost"
