...
if __name__ == '__main__':
    ...
    learning_rate_dict: dict = {"learning rate 0.5": 0.5,
    ...
    plot_id = 1
    plot_title = "MSE over different learning rate"
    x_label = "Iterations"
    y_label = "MSE"
    ...
    plot_id = 2
    plot_title = "Misclassification count over different learning rate"
    x_label = "Iterations"
