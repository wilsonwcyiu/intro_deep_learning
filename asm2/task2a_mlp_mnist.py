...
if __name__ == '__main__':
    ...
    result_output_file = folder_dir + date_time_str + "_permutation_result_mlp_mnist_output.csv"
    result_backup_output_file = folder_dir + date_time_str + "_permutation_result_mlp_mnist_output_backup.csv"
