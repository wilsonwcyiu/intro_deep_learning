...
if __name__ == '__main__':
    ...
    result_output_file = folder_dir + date_time_str + "_permutated_result_cnn_fashion_output.csv"
    result_backup_output_file = folder_dir + date_time_str + "_permutated_result_cnn_fashion_output_backup.csv"
